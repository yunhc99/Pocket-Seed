...
public class Outcome extends JFrame {
	...
	private ImageIcon BackButtonEnterImage = new ImageIcon(
			Main.class.getResource("../image/OutcomeBackButtonEnter.png"));
	private ImageIcon SaveButtonImage = new ImageIcon(Main.class.getResource("../image/OutcomeSaveButton.png"));
	private ImageIcon SaveButtonEnterImage = new ImageIcon(
			Main.class.getResource("../image/OutcomeSaveButtonEnter.png"));
	private ImageIcon ExitButtonImage = new ImageIcon(Main.class.getResource("../image/OutcomeExitButton.png"));
	private ImageIcon ExitButtonEnterImage = new ImageIcon(
			Main.class.getResource("../image/OutcomeExitButtonEnter.png"));
	...
	String contect[][] = { { "09:30~10:20", "", "", "", "", "" }, { "10:30~11:20", "", "", "", "", "" },
			{ "11:30~12:20", "", "", "", "", "" }, { "12:30~13:20", "", "", "", "", "" },
			{ "13:30~14:20", "", "", "", "", "" }, { "14:30~15:20", "", "", "", "", "" },
			{ "15:30~17:20", "", "", "", "", "" }, { "17:30~18:20", "", "", "", "", "" },
			{ "18:30~19:20", "", "", "", "", "" } };
//

	private int mouseX, mouseY;

	public Outcome(ArrayList<ArrayList<Sub_dater>> list_base_base, ArrayList<Sub_dater> information_nec,
			ArrayList<Sub_dater> information_sel, DefaultListModel sum_model) {
		...
		SaveButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				try {
					...
					Rectangle rectangle = new Rectangle((screenSize.width - frameSize.width) / 2,
							(screenSize.height - frameSize.height) / 2, Main.SCREEN_WIDTH, Main.SCREEN_HEIGHT);
					...
					if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
						...
						ImageIO.write(image, saveFileExtension,
								new File(file.getAbsolutePath() + "." + saveFileExtension));
